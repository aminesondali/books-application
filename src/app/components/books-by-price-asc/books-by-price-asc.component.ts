...
@Component({
  selector: 'app-books-by-price-asc',
  templateUrl: './books-by-price-asc.component.html',
  styleUrls: ['./books-by-price-asc.component.css']
})
export class BooksByPriceAscComponent implements OnInit {
  ...
  ngOnInit() {
    this.bookService.getBooksByPriceAsc().subscribe((resultat) => {
      this.books = resultat;
    });
