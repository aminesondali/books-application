...
@Component({
  selector: 'app-books-by-note',
  templateUrl: './books-by-note.component.html',
  styleUrls: ['./books-by-note.component.css']
})
export class BooksByNoteComponent implements OnInit {
